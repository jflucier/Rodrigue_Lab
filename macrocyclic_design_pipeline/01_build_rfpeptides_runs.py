...
def main():
    ...
    out_dir = Path(args.out_dir).resolve()  # Convert to absolute path for container binding
    ...
    with open(args.targets_tsv, newline="") as fh:
        ...
        for row in reader:
            ...
            if not name:
                continue
            pdb_path = Path(row["pdb_path"].strip()).resolve()  # Ensure full path for container compatibility
